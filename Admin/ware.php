                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="emp.php"><i class="icon-people"></i>Employee Details</a>
                            </li>
                            <li class="nav-item ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="voul.php"><i class="fa fa-child"></i>Voulenteer Details</a>
                            </li>

                            <li class="nav-item ">
                                <a class="nav-link active" href="ware.php"><i class="fa fa-child"></i>Warehouse</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Admin's Dashboard </h2>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Lot no.</th>
                                                        <th class="border-0">Sender name</th>
                                                        <th class="border-0">Quantity</th>
                                                        <th class="border-0">Product type</th>
                                                        <th class="border-0">Sender id</th>
                                                        <th class="border-0">Recieved date</th>
                                                        <th class="border-0">Delivered date</th>                                            
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php 
