                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active " href="events.php"><i class="fa fa-puzzle-piece"></i>Event Details</a>
                            </li>
                            <li class="nav-item ">
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">    
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <h5 class="card-header">Attended Event Details</h5>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Event Head</th>
                                                        <th class="border-0">Date</th>
                                                        <th class="border-0">No. of Paticipants</th>                                            
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php 
