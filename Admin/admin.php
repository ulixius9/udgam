                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="dash.html"><i class="fa fa-fw fa-user-circle"></i>Dashboard</a>
                            </li>
                            <li class="nav-item ">
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Students Id</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td><a href="student_details.html">Ashish Tiwari</a></td>
                                                        <td>id000001 </td>
                                                        <td>10</td>
                                                        <td>M</td>
                                                        <td>8th</td>
                                                        <td>Holy Cross High School </td>
                                                        <td><span class="badge-dot badge-brand mr-1"></span>Del</td>
                                                    </tr>
                                                    <tr>
