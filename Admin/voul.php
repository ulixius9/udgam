                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="voul.php"><i class="fa fa-child"></i>Voulenteer Details</a>
                            </li>
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">    
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <h5 class="card-header">Voulenteer Details</h5>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0">vid</th>
                                                        <th class="border-0">Voulenteer Name</th>
                                                        <th class="border-0">No. of Events</th>
                                                        <th class="border-0">Gender</th>
                                                        <th class="border-0">No. of Students</th>
                                                        <th class="border-0">Delete Voulenteer</th>                                            
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php 
