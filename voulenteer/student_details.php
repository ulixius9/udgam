...
$sql="select * from child,cdata,school where child.cid=cdata.cid and child.sid=school.sid and  child.cid=".$_GET['cid'];
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">    
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header d-flex">
                                        <h5 class="card-header-title">Student Details </h5>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <h5 class="card-header">Sem Details</h5>
                                    <div class="card-body">
